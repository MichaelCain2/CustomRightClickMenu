...
(function (EditCrmElement) {
    ...
    var EC = (function () {
        ...
        EC._addNodeType = function (nodeType) {
            return this.___("options_editCrm_addNodeType", window.app.crm.getI18NNodeType(nodeType));
        };
        ...
        EC.addToPosition = function (e) {
            ...
            var menuPath = JSON.parse(node.getAttribute('data-path'));
        ...
        EC._addItem = function (path, type) {
            var newItem = window.app.templates.getDefaultNodeOfType(type, {
                id: window.app.generateItemId()
            });
